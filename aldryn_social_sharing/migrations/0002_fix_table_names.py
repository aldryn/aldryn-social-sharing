...
class Migration(DataMigration):
    ...
    cms_plugin_table_mapping = (
        # (old_name, new_name),
        ('cmsplugin_like', 'aldryn_social_sharing_like'),
        ('cmsplugin_mail', 'aldryn_social_sharing_mail'),
        ('cmsplugin_links', 'aldryn_social_sharing_links'),
    )
